...
//  ToDo List
//
//  Created by Jackson on 05/02/2017.
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadTableWhenNewEventAdded) name:@"NewEvent" object:nil];
...
- (void) reloadTableWhenNewEventAdded {
